...
className = ["person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", "boat",
              ...
              "teddy bear", "hair drier", "toothbrush"]  # keep your class list
...
while True:
    ...
    # IMPORTANT: use mask parameter
    imgRegion = cv2.bitwise_and(img, img, mask=cv2.cvtColor(mask_resized, cv2.COLOR_BGR2GRAY))
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if currentClass in ["car", "truck", "bus", "motorbike"] and conf > 0.3:
                ...
                #create little circle to detect object
